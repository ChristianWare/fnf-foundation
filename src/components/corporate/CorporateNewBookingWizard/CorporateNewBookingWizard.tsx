...
export default function CorporateNewBookingWizard({
  ...
  function applyAirportToRoute(side: "pickup" | "dropoff", airportId: string) {
    ...
    if (lat == null || lng == null) {
      toast.error(
        `That airport is missing coordinates. Please contact ${SITE.name}.`,
      );
      return;
    }
          ...
          <div className={styles.wizard}>
                  ...
                  {selectedVehicle?.callForPricing ? (
                    <>
                      ...
                      <div className='miniNote'>
                        ...
                        request and {SITE.name} will contact you with
                        pricing.
                      </div>
                    </>
                  ) : (
            ...
            {step === 4 && (
              <div className={`${styles.stepPane} ${styles.confirmedPane}`}>
                ...
                <p className='subheading'>
                  {isMultiLeg
                    ? `Your ${savedLegs.length + 1}-ride trip has been confirmed and ${SITE.name} has been notified.`
                    : `Your ride has been confirmed and ${SITE.name} has been notified.`}
                </p>
